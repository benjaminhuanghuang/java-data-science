...
public class NaiveBayesClassifier {
  ...
  private Double getLabelProbabilityForPoint(
    List<Double> groupColumnMeans,
    List<Double> groupColumnStdDevs,
    DataItem item
  ) {
  ...
  public Map<String, Double> classifyPoint(DataItem unlabelledPoint) {
    ...
    for (String label : allLabels) {
      // data belong to label
      List<DataItem> groupDataItems =
        this.dataItems.stream()
